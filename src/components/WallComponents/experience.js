...
class Experience extends Component {
  ...
  render() {
    ...
    return (<article className="moment">
      <div className="profile">
        <a href="#">
          ...
          <p className="username">{experience.user.surname}
            {experience.user.name}</p>
        </a>
      </div>
      ...
      <div className="content">
        ...
        <div className="comments">
          <ul>
            <li>
              <span className="username">JariVerswyvel</span>&nbsp;&nbsp;Lorem ipsum dolor sit amet, consectetur adipiscing elit
            </li>
          </ul>
          <ul className="hide">
            <li>
              <span className="username">JariVerswyvel</span>&nbsp;&nbsp;Lorem ipsum dolor sit amet, consectetur adipiscing elit Lorem ipsum dolor sit amet, consectetur adipiscing elit Lorem ipsum dolor sit amet, consectetur adipiscing elit
            </li>
            <li>
              <span className="username">CisVercoutren</span>&nbsp;&nbsp;Lorem ipsum dolor sit amet, consectetur adipiscing elit
            </li>
            <li>
              <span className="username">WizardVr</span>&nbsp;&nbsp;Lorem ipsum dolor sit amet, consectetur adipiscing elit
            </li>
            <li>
              <span className="username">SpaBlauw</span>&nbsp;&nbsp;Lorem ipsum dolor sit amet, consectetur adipiscing elit
            </li>
          </ul>
      ...
      <div className="content images">
        ...
        <p className="pointer" onClick={this.openMoments}>See more moments</p>
      </div>
    </article>)
  }
}
